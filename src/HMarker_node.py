...
def imu_measure_node():
    ...
    sub_1 = rospy.Subscriber('/adq/imu_rel/imu2_realtive_imu1/data', Imu, callback_imu1, queue_size=1)
    pub_1=rospy.Publisher('adq/Marker/Head',Marker,queue_size=3)
    while not rospy.is_shutdown():
        ...
        MrkRGBA = [float(c) for c in colors.to_rgba('orange')]
