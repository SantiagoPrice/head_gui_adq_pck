...
# @Last Modified time: 2022-12-11 19:36:40
...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        try:
            trans1 = tfBuffer.lookup_transform("imu1_initial", "imu1_q", rospy.Time())
            trans_1 = trans1.transform
            trans2 = tfBuffer.lookup_transform("imu2_initial", "imu2_q", rospy.Time())
            trans_2 = trans2.transform
            ...
            set_frame(trans_1.rotation, "imu1_relative")
            set_frame(trans_2.rotation, "imu2_relative")
